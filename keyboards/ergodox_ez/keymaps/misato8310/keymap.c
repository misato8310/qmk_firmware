...
#define JA_HANZEN KC_GRV // Hankaku and Zenkaku
...
[BASE] = LAYOUT_ergodox(
  // left hand
  CTL_T(KC_ESC),   KC_1,           KC_2,          KC_3,    KC_4,    KC_5,    KC_LEFT,
  KC_TAB,          KC_Q,           KC_W,          KC_E,    KC_R,    KC_T,    JA_HAT,
  KC_LCTRL,        KC_A,           KC_S,          KC_D,    KC_F,    KC_G,
  KC_LSFT,         KC_Z,           KC_X,          KC_C,    KC_V,    KC_B,    ALL_T(KC_NO),
  LT(SYMB,KC_GRV), GUI_T(JA_CLON), LALT(KC_LSFT), KC_LEFT, KC_RGHT,
                                                           ALT_T(KC_APP), JA_ENUN,
                                                                          KC_DELT,
 ...
 * .---------------------------------------------. .---------------------------------------------.
 * | VRSN  | F1  | F2  | F3  | F4  | F5  |       | !       | F6  | F7  | F8  |PSLS |PAST |  F11  |
 * !-------+-----+-----+-----+-----+-------------! !-------+-----+-----+-----+-----+-----+-------!
 * |       |EXLM | AT  |LCBR |RCBR |PIPE |       | !       | UP  |  7  |  8  |  9  |MINS | TILD  |
 * !-------+-----+-----+-----x-----x-----!       ! !       !-----x-----x-----+-----+-----+-------!
 * |       |HASH | DLR |LPRN |RPRN | GRV |-------! !-------!DOWN |  4  |  5  |  6  |PPLS | ASTR  |
 * !-------+-----+-----+-----x-----x-----!       ! !       !-----x-----x-----+-----+-----+-------!
 * |       |PERC |CIRC |LBRC |RBRC |TILD |       | !       |AMPR |  1  |  2  |  3  | ENT |       |
 * '-------+-----+-----+-----+-----+-------------' '-------------+-----+-----+-----+-----+-------'
...
[SYMB] = LAYOUT_ergodox(
  ...
  // right hand
  KC_TRNS, KC_F6,   KC_F7,   KC_F8,   KC_PSLS, KC_PAST,  KC_F11,
  KC_TRNS, KC_UP,   KC_7,    KC_8,    KC_9,    KC_MINS,  KC_TILD,
  KC_DOWN, KC_4,    KC_5,    KC_6,    KC_PPLS, KC_ASTR,
  KC_TRNS, KC_AMPR, KC_1,    KC_2,    KC_3,    KC_ENT,   KC_TRNS,
  KC_TRNS, KC_0,    KC_DOT,  JA_HAT,  JA_ENUN,
  RGB_TOG, RGB_SLD,
  KC_TRNS,
  JA_HANZEN, RGB_HUD, RGB_HUI
),
